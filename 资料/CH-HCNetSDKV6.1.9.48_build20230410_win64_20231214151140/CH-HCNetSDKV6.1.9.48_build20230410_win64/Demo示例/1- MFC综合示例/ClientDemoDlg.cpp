...
LRESULT CClientDemoDlg::OnWMProcAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    case COMM_SCENECHANGE_DETECTION_UPLOAD://2013-07-17场景变更侦测报警
        ...
        break;
    case COMM_FACECAPTURE_STATISTICS_RESULT://抓拍统计上传
...
void CClientDemoDlg::ProcFacecaptureStatistics(WPARAM wParam, LPARAM lParam)//抓拍统计上传
{
	char szInfoBuf[1024] = {0}; 
	char szLan[128] = {0};
	LPLOCAL_ALARM_INFO pAlarmDev = (LPLOCAL_ALARM_INFO)(wParam);
	...
	g_StringLanType(szLan, "抓拍统计上传","Face Capture Statistics Upload");
