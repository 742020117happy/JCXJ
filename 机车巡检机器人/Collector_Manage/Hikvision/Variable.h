...
public:
	...
	static s_Hikvision_DB  g_Hikvision_DB;
	...
	static void CALLBACK RealDataCallBack_V30(LONG lRealHandle, DWORD dwDataType, BYTE *pBuffer, DWORD dwBufSize, DWORD dwUser);
	//数据解码回调函数，将YV_12格式的视频数据流转码为可供opencv处理的BGR类型的图片数据，并实时显示。
    // PlayM4_SetDecCallBackEx(int nPort,void (CALLBACK* DecCBFun), char* pDest, int nDestSize);
